...
")
  ...
  elseif("${CMAKE_GENERATOR}" MATCHES "Visual Studio ([0-9]+)")
    ...
    if(CMAKE_VS_PLATFORM_TOOLSET)
      ...
      if(NOT CMAKE_VS_PLATFORM_TOOLSET MATCHES "clang")
        set(id_precompiled_header "<PrecompiledHeader></PrecompiledHeader>")
        set(id_debug_information_format "<DebugInformationFormat></DebugInformationFormat>")
      endif()
    else()
      set(id_toolset "")
    endif()
